...
> **Summary**: Phase 2 RAG 파이프라인 상세 설계 — 뉴스 수집·번역·요약 · AI 시그널 (Gemini 1.5 Flash + JSON mode) · 4-level 금지용어 가드 · `/detail` hydrate · Flyway V2/V3 증분 · FE NewsPanel/AiSignalPanel.
>
...
#### V3__phase2_ai_signal_audit.sql
...
- [ ] **Flyway V2/V3 마이그레이션**: 빈 DB 에 V1→V2→V3 적용 성공, rollback 불필요 (forward-only)
