...
public class NewsTranslator {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            4. DO NOT produce investment advice, buy/sell recommendations, profit guarantees,
               or imperative commands ("사세요", "파세요", "매수하세요", etc.).
    ...
    public Translation translate(CompanyNews news) {
        ...
        try {
            LlmClient.LlmResult result = llmClient.generate(SYSTEM_PROMPT, userPrompt);
