            ...
            >
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="cursor-pointer rounded p-1.5 text-fg-muted transition-colors hover:bg-bg-muted hover:text-fg-secondary"
                ...
                <button
                  ...
                  className="cursor-pointer rounded p-1.5 text-fg-muted transition-colors hover:bg-red-50 hover:text-danger disabled:opacity-50 dark:hover:bg-red-900/20"
