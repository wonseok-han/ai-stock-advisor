...
|----------|---------|----------|-----------|
| **FE Framework** | Next.js 16 / Remix / Nuxt | **Next.js 16 App Router** (React 19 + Tailwind 4) | SSR/SSG 혼합(SEO 10종목 랜딩), Vercel 1-click 배포, AI 도구 지원 최상 |
...
| **BE Framework** | Spring Boot 3 / Quarkus / Fastify | **Spring Boot 3.5.13 / Java 21** | 가상 스레드로 I/O 병렬, JPA 생태계, ta4j Java 네이티브. Initializr 최소 지원선(3.5) 준수 |
